...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.helmboot.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".helmboot" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".helmboot")
	}
